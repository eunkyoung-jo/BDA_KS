#2018.10
#from: https://github.com/Macuyiko/webscrapingfordatascience/blob/master/python-examples/books-to-scrape/scraper.py
...
db = dataset.connect('sqlite:///data/books.db')
